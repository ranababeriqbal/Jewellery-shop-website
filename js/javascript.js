...
window.addEventListener("scroll", function () {
  ...
  var navthree = document.getElementById('mainheadernav');
  navthree.classList.toggle("sticky", window.scrollY > 0);
  navthree.classList.toggle("fixed-top", window.scrollY > 0);
});
